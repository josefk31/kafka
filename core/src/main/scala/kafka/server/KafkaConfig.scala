...
class KafkaConfig private(doLog: Boolean, val props: util.Map[_, _])
  ...
  def uncleanRecoveryManagerEnable: java.lang.Boolean = getBoolean(ReplicationConfigs.UNCLEAN_RECOVERY_MANAGER_ENABLE_CONFIG)
  ...
  def extractLogConfigMap: java.util.Map[String, Object] = {
    ...
    logProps.put(TopicConfig.UNCLEAN_RECOVERY_MANAGER_ENABLE_CONFIG, uncleanRecoveryManagerEnable)
