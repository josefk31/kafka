...
public class ReplicationConfigs {
    ...
    public static final String UNCLEAN_RECOVERY_MANAGER_ENABLE_CONFIG = ServerTopicConfigSynonyms.serverSynonym(TopicConfig.UNCLEAN_RECOVERY_MANAGER_ENABLE_CONFIG);
    public static final String UNCLEAN_RECOVERY_MANAGER_ENABLE_DOC = "TODO";
    ...
    public static final ConfigDef CONFIG_DEF =  new ConfigDef()
            ...
            .define(UNCLEAN_RECOVERY_MANAGER_ENABLE_CONFIG, BOOLEAN, LogConfig.DEFAULT_UNCLEAN_RECOVERY_MANAGER, HIGH, UNCLEAN_RECOVERY_MANAGER_ENABLE_DOC)
